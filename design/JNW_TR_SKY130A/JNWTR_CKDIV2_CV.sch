...
C {JNW_TR_SKY130A/JNWTR_TAPCELLB_CV.sym} 400 0 0 0 {name=XXA12v}
...
C {JNW_TR_SKY130A/JNWTR_BFX1_CV.sym} 400 150.0 0 0 {name=XXA1}
...
N 460.0 110.0 440.0 110.0 {lab=AVDD}
C {devices/lab_pin.sym} 460.0 110.0 2 0 {name=l4 sig_type=std_logic lab=AVDD }
N 460.0 190.0 440.0 190.0 {lab=AVSS}
C {devices/lab_pin.sym} 460.0 190.0 2 0 {name=l5 sig_type=std_logic lab=AVSS }
C {JNW_TR_SKY130A/JNWTR_IVX1_CV.sym} 400 340.0 0 0 {name=XXA2}
...
C {devices/lab_pin.sym} 460.0 300.0 2 0 {name=l8 sig_type=std_logic lab=AVDD }
N 460.0 380.0 440.0 380.0 {lab=AVSS}
C {devices/lab_pin.sym} 460.0 380.0 2 0 {name=l9 sig_type=std_logic lab=AVSS }
C {JNW_TR_SKY130A/JNWTR_DFRNQNX1_CV.sym} 400 530.0 0 0 {name=XXA4}
...
N 410.0 560.0 430.0 560.0 {lab=RN}
C {devices/lab_pin.sym} 410.0 560.0 0 0 {name=l12 sig_type=std_logic lab=RN }
...
N 480.0 440.0 460.0 440.0 {lab=AVDD}
C {devices/lab_pin.sym} 480.0 440.0 2 0 {name=l15 sig_type=std_logic lab=AVDD }
N 480.0 560.0 460.0 560.0 {lab=AVSS}
C {devices/lab_pin.sym} 480.0 560.0 2 0 {name=l16 sig_type=std_logic lab=AVSS }
C {JNW_TR_SKY130A/JNWTR_IVX1_CV.sym} 400 760.0 0 0 {name=XXA3}
...
N 460.0 720.0 440.0 720.0 {lab=AVDD}
C {devices/lab_pin.sym} 460.0 720.0 2 0 {name=l19 sig_type=std_logic lab=AVDD }
N 460.0 800.0 440.0 800.0 {lab=AVSS}
C {devices/lab_pin.sym} 460.0 800.0 2 0 {name=l20 sig_type=std_logic lab=AVSS }
C {JNW_TR_SKY130A/JNWTR_ANX1_CV.sym} 400 950.0 0 0 {name=XXA5}
...
N 420.0 900.0 440.0 900.0 {lab=AVDD}
C {devices/lab_pin.sym} 420.0 900.0 0 0 {name=l24 sig_type=std_logic lab=AVDD }
N 420.0 980.0 440.0 980.0 {lab=AVSS}
C {devices/lab_pin.sym} 420.0 980.0 0 0 {name=l25 sig_type=std_logic lab=AVSS }
